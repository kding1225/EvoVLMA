    ...
    def __init__(self, api_endpoint, api_key, model_LLM, debug_mode,prompts, **kwargs):
        ...
        if self._use_local_llm:
            ...
            self.interface_llm = InterfaceLLM(
                self.api_endpoint, self.api_key, self.model_LLM,
                self._use_local_llm,self._url, self.debug_mode
            )
...
+self.prompt_other_inf+"\n"+"Do not give additional explanations."
    ...
    def i1(self):
        ...
        [code_all, algorithm] = self._get_alg(prompt_content, "i1")
    ...
    def crossover(self, parents):
        ...
        [code_all, algorithm] = self._get_alg(prompt_content, "crossover")
    ...
    def mutation(self, parents):
        ...
        [code_all, algorithm] = self._get_alg(prompt_content, "mutation")
