...
exp_output_path = f"{net}_evol/{srcdata0}_inst{inst}_nt{ntest_per_class}/{method}_joint/{evomethod}_popsize{ec_pop_size}_npop{ec_n_pop}_sc{sample_class}"
makedirs(exp_output_path)

# *************** optimization for logit computation and feature selection ***************
...
paras.set_paras(method = evomethod,    # ['ael','eoh']
                problem = "joint", #['tsp_construct','bp_online']
                ...
                exp_use_seed = True,
                exp_seed_path = f"seeds/logit_func_opt-{method}-joint.json",
